...
export const soundConfig = {
  ...
  guessCorrect: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/battle/critical_hit.mp3',
  guessIncorrect: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/battle/hero_magic_miss.mp3',
  roundWin: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/ui/reward.mp3',
  roundLose: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/battle/enemy_hit.mp3',
  ...
  buttonClick: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/ui/cursor_select.mp3',
  gameStart: 'https://cdn.jsdelivr.net/gh/sfbg/kor-sfx-rpg@master/mp3/ui/menu_open.mp3',
};
